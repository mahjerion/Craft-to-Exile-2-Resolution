...
events.listen('rei.hide.items', function (event) {
  ...
  event.hide('adventurez:spawn_stone_golem')
  event.hide('adventurez:spawn_small_stone_golem')
  event.hide('adventurez:spawn_piglin_beast')
  event.hide('adventurez:spawn_nightmare')
  event.hide('adventurez:spawn_soul_reaper')
  event.hide('adventurez:spawn_necromancer')
  event.hide('adventurez:spawn_wither_puppet')
  event.hide('adventurez:spawn_skeleton_vanguard')
  event.hide('adventurez:spawn_summoner')
  event.hide('adventurez:spawn_blaze_guardian')
  event.hide('adventurez:spawn_the_eye')
  event.hide('adventurez:spawn_void_shadow')
  event.hide('adventurez:spawn_red_fungus')
  event.hide('adventurez:spawn_brown_fungus')
  event.hide('adventurez:spawn_orc')
  event.hide('adventurez:spawn_dragon')
  event.hide('adventurez:spawn_mammoth')
  event.hide('adventurez:spawn_void_fragment')
  event.hide('adventurez:spawn_void_shade')
  event.hide('betterend:spawn_egg_dragonfly')
  event.hide('betterend:spawn_egg_end_slime')
  event.hide('betterend:spawn_egg_end_fish')
  event.hide('betterend:spawn_egg_shadow_walker')
  event.hide('betterend:spawn_egg_cubozoa')
  event.hide('betternether:spawn_egg_firefly')
  event.hide('betternether:spawn_egg_hydrogen_jellyfish')
  event.hide('betternether:spawn_egg_naga')
  event.hide('betternether:spawn_egg_flying_pig')
  event.hide('betternether:spawn_egg_jungle_skeleton')
  event.hide('betternether:spawn_egg_skull')
  event.hide('zoob:spawn_monster_of_the_ocean_depths')
  event.hide('eymbra:hadrosaur_spawn_egg')
  event.hide('eymbra:dragonfly_spawn_egg')
  event.hide('eymbra:tarslime_spawn_egg')
  event.hide('eymbra:ichthyosaurus_spawn_egg')
  event.hide('eymbra:pachycepalosaurus_spawn_egg')
  event.hide('eymbra:dodo_spawn_egg')
  event.hide('eymbra:ankylosaurus_spawn_egg')
