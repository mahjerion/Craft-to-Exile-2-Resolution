...
Last README file update: Fri Oct 29 16:12:36 EDT 2021
...
command.gendungeon
command.gendungeon.x
command.gendungeon.x.z
command.give
command.give.targets
command.give.targets.item
command.give.targets.item.count
command.givekey
command.givekey.advanced
command.givekey.advanced.target
command.givekey.advanced.target.theme
command.givekey.basic
command.givekey.basic.target
command.givekey.basic.target.theme
command.givekey.blank
command.givekey.blank.target
command.givekey.blank.target.theme
command.help
...
command.illagers_plus
command.illagers_plus.display_struc_config_vals
command.illagers_plus.display_struc_config_vals.structure
command.illagers_plus.mod_info
command.jer_profile
...
command.locate.illagers_plus:ice_castle
command.locate.illagers_plus:illager_archer_tower
command.locate.illagers_plus:illager_centre
command.locate.illagers_plus:illager_fort
command.locate.illagers_plus:illager_mine
command.locate.illagers_plus:illager_tower
...
command.locate.pandoras_creatures:end_prison
...
command.locate.the_bumblezone:honey_cave_room
command.locate.the_bumblezone:pollinated_stream
...
command.locate.world_of_exile:stone_brick_tower
command.locatebiome
